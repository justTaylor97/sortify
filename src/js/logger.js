...
var logger = winston.createLogger({
    level: "info",
    format: winston.format.combine(winston.format.errors({ stack: true }), winston.format.metadata(), winston.format.colorize({ all: true }), winston.format.printf(function (info) {
...
switch (process.env.LEVEL) {
    ...
    case undefined:
        break;
    default:
        logger.warn(process.env.LEVEL + " is not a valid logging level. Refer to https://github.com/winstonjs/winston#logging-levels for valid levels.");
        break;
}
